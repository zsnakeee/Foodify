                ...
                <div class="col-md-4 col-6">
                    <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                                ...
                                <li class="menu-item">
                                    ...
                                    <div class="sub-menu submenu-default">
                                        <ul class="menu-list">
                                            ...
                                            <li class="d-flex">
                                                <a href="" class="menu-link-text link text_black-2">Wishlist</a>
                                            </li>

                                            <li class="d-flex">
                                                <a href="" class="menu-link-text link text_black-2">Cart</a>
                                            </li>
                                            <hr>

                                            <li class="d-flex">
                                                <a href="{{-- route('logout') --}}"
                                                   class="menu-link-text link text_black-2">Logout</a>
                                            </li>
                        ...
                        <li class="nav-wishlist">
                            <a href="wishlist.html" class="nav-icon-item  align-items-center gap-10">
                                    ...
                                    <div class="container">
                                        <div class="row-demo">
                                            <div class="demo-item">
                                                <a href="index.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-01.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-01.jpg") }}"
                                                             alt="home-01">
                                            ...
                                            <div class="demo-item">
                                                <a href="home-multi-brand.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-multi-brand.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-multi-brand.jpg") }}"
                                            ...
                                            <div class="demo-item">
                                                <a href="home-02.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-02.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-02.jpg") }}"
                                                             alt="home-02">
                                                        <div class="demo-label">
                                                            <span class="demo-hot">Hot</span>
                                                        </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-03.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-03.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-03.jpg") }}"
                                                             alt="home-03">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-04.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-04.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-04.jpg") }}"
                                                             alt="home-04">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-05.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-05.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-05.jpg") }}"
                                                             alt="home-05">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-06.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-06.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-06.jpg") }}"
                                                             alt="home-06">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-personalized-pod.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-personalized-pod.jpg") }}"
                                                             src="{{ asset("assets/images/demo/home-personalized-pod.jpg") }}"
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-pickleball.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-pickleball.png") }}"
                                                             src="{{ asset("assets/images/demo/home-pickleball.png") }}"
                                                             alt="home-pickleball">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-ceramic.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-ceramic.png") }}"
                                                             src="{{ asset("assets/images/demo/home-ceramic.png") }}"
                                                             alt="home-ceramic">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-food.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-food.png") }}"
                                                             src="{{ asset("assets/images/demo/home-food.png") }}"
                                                             alt="home-food">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-camp-and-hike.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload"
                                                             data-src="{{ asset("assets/images/demo/home-camp-and-hike.png") }}"
                                                             src="{{ asset("assets/images/demo/home-camp-and-hike.png") }}"
                                        ...
                                        <div class="text-center view-all-demo">
                                            <a href="#modalDemo" data-bs-toggle="modal"
                                               class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View all demos (39+)</span><i
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="shop-fullwidth.html" class="menu-link-text link">Fullwidth</a>
                                                        </li>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        <li><a href="shop-link.html" class="menu-link-text link">Pagination
                                                                links</a></li>
                                                        <li><a href="shop-loadmore.html" class="menu-link-text link">Pagination
                                                                loadmore</a></li>
                                                ...
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-style-03.html" class="menu-link-text link">Product
                                                                style 03</a></li>
                                                        <li><a href="product-style-04.html" class="menu-link-text link">Product
                                                                style 04</a></li>
                                                        <li><a href="product-style-05.html" class="menu-link-text link">Product
                                                                style 05</a></li>
                                                        <li><a href="product-style-06.html" class="menu-link-text link">Product
                                                                style 06</a></li>
                                                        <li><a href="product-style-07.html" class="menu-link-text link">Product
                                                                style 07</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="collection-item hover-img">
                                                    <div class="collection-inner">
                                                        <a href="shop-men.html" class="collection-image img-style">
                                                            <img class="lazyload"
                                                                 data-src="{{ asset("assets/images/collections/collection-1.jpg") }}"
                                                                 src="{{ asset("assets/images/collections/collection-1.jpg") }}"
                                                ...
                                                <div class="collection-item hover-img">
                                                    <div class="collection-inner">
                                                        <a href="shop-women.html" class="collection-image img-style">
                                                            <img class="lazyload"
                                                                 data-src="{{ asset("assets/images/collections/collection-2.jpg") }}"
                                                                 src="{{ asset("assets/images/collections/collection-2.jpg") }}"
                                                                 alt="collection-demo-1">
                                                        </a>
                                                        <div class="collection-content">
                                                ...
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        <li><a href="product-detail.html" class="menu-link-text link">Product
                                                                default</a></li>
                                                        <li><a href="product-grid-1.html" class="menu-link-text link">Product
                                                                grid 1</a></li>
                                                        <li><a href="product-grid-2.html" class="menu-link-text link">Product
                                                                grid 2</a></li>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-no-zoom.html" class="menu-link-text link">Product
                                                                no zoom</a></li>
                                                        ...
                                                        <li><a href="product-giftcard.html" class="menu-link-text link">Recipient
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-notification.html"
                                                               class="menu-link-text link">Back in stock
                                                                notification</a></li>
                                                        <li><a href="product-pickup.html" class="menu-link-text link">Product
                                                                pickup</a></li>
                                                                    ...
                                                                    <div class="card-product-wrapper">
                                                                        <a href="#" class="product-img">
                                                                            <img class="lazyload img-product"
                                                                                 data-src="{{ asset("assets/images/products/orange-1.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/orange-1.jpg") }}"
                                                                                 alt="image-product">
                                                                            <img class="lazyload img-hover"
                                                                                 data-src="{{ asset("assets/images/products/white-1.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/white-1.jpg") }}"
                                                                                 alt="image-product">
                                                                        </a>
                                                                        <div class="list-product-btn absolute-2">
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               class="box-icon bg_white wishlist btn-icon-action">
                                                                                ...
                                                                                <span
                                                                                    class="tooltip">Add to Wishlist</span>
                                                                            ...
                                                                            <a href="#compare"
                                                                               ...
                                                                               class="box-icon bg_white compare btn-icon-action">
                                                                                ...
                                                                                <span
                                                                                    class="tooltip">Add to Compare</span>
                                                                    ...
                                                                    <div class="card-product-info">
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            ...
                                                                            <li class="list-color-item color-swatch">
                                                                                ...
                                                                                <img class="lazyload"
                                                                                     data-src="{{ asset("assets/images/products/black-1.jpg") }}"
                                                                                     src="{{ asset("assets/images/products/black-1.jpg") }}"
                                                                                     alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                ...
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product"
                                                                                 data-src="{{ asset("assets/images/products/white-3.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/white-3.jpg") }}"
                                                                                 alt="image-product">
                                                                            <img class="lazyload img-hover"
                                                                                 data-src="{{ asset("assets/images/products/white-4.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/white-4.jpg") }}"
                                                                                 alt="image-product">
                                                                        </div>
                                                                        <div class="list-product-btn absolute-2">
                                                                            <a href="#shoppingCart"
                                                                    ...
                                                                    <div class="card-product-info">
                                                                        <a href="#" class="title link">Oversized Printed
                                                                            T-shirt</a>
                                                            ...
                                                            <div class="swiper-slide" lazy="true">
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product"
                                                                                 data-src="{{ asset("assets/images/products/white-2.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/white-2.jpg") }}"
                                                                                 alt="image-product">
                                                                            <img class="lazyload img-hover"
                                                                                 data-src="{{ asset("assets/images/products/pink-1.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/pink-1.jpg") }}"
                                                                                 alt="image-product">
                                                                        </div>
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            ...
                                                                            <li class="list-color-item color-swatch">
                                                                                ...
                                                                                <span
                                                                                    class="swatch-value bg_dark"></span>
                                                                                <img class="lazyload"
                                                                                     data-src="{{ asset("assets/images/products/black-2.jpg") }}"
                                                                                     src="{{ asset("assets/images/products/black-2.jpg") }}"
                                                                                     alt="image-product">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                            ...
                                                            <div class="swiper-slide" lazy="true">
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product"
                                                                                 data-src="{{ asset("assets/images/products/brown-2.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/brown-2.jpg") }}"
                                                                                 alt="image-product">
                                                                            <img class="lazyload img-hover"
                                                                                 data-src="{{ asset("assets/images/products/brown-3.jpg") }}"
                                                                                 src="{{ asset("assets/images/products/brown-3.jpg") }}"
                                                                                 alt="image-product">
                                                                        </div>
                                                                        <div class="size-list">
                                                                            <span>S</span>
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            ...
                                                                            <li class="list-color-item color-swatch">
                                                                                ...
                                                                                <span
                                                                                    class="swatch-value bg_white"></span>
                                                                                <img class="lazyload"
                                                                                     data-src="{{ asset("assets/images/products/white-5.jpg") }}"
                                                                                     src="{{ asset("assets/images/products/white-5.jpg") }}"
                                                                                     alt="image-product">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                            ...
                            <li class="menu-item position-relative">
                                ...
                                <div class="sub-menu submenu-default">
                                    <ul class="menu-list">
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    ...
                                                    <li><a href="brands-v2.html"
                                                           class="menu-link-text link text_black-2">Brand V2</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="menu-item-2">
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    <li><a href="contact-1.html"
                                                           class="menu-link-text link text_black-2">Contact 1</a></li>
                                                    <li><a href="contact-2.html"
                                                           class="menu-link-text link text_black-2">Contact 2</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="menu-item-2">
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    <li><a href="faq-1.html" class="menu-link-text link text_black-2">FAQ
                                                            01</a></li>
                                                    <li><a href="faq-2.html" class="menu-link-text link text_black-2">FAQ
                                                            02</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    <li><a href="our-store.html"
                                                           class="menu-link-text link text_black-2">Our store</a></li>
                                                    <li><a href="store-locations.html"
                                                           class="menu-link-text link text_black-2">Store locator</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    ...
                                                    <li><a href="payment-failure.html"
                                                           class="menu-link-text link text_black-2">Payment Failure</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                            ...
                                            <div class="sub-menu submenu-default">
                                                <ul class="menu-list">
                                                    <li><a href="my-account.html"
                                                           class="menu-link-text link text_black-2">My account</a></li>
                                                    <li><a href="my-account-orders.html"
                                                           class="menu-link-text link text_black-2">My order</a></li>
                                                    <li><a href="my-account-orders-details.html"
                                                           class="menu-link-text link text_black-2">My order details</a>
                                                    </li>
                                                    <li><a href="my-account-address.html"
                                                           class="menu-link-text link text_black-2">My address</a></li>
                                                    <li><a href="my-account-edit.html"
                                                           class="menu-link-text link text_black-2">My account
                                                            details</a></li>
                                                    <li><a href="my-account-wishlist.html"
                                                           class="menu-link-text link text_black-2">My wishlist</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li><a href="404.html"
                                               class="menu-link-text link text_black-2 position-relative">404</a></li>
                                ...
                                <div class="sub-menu submenu-default">
                                    <ul class="menu-list">
                                        <li><a href="blog-grid.html" class="menu-link-text link text_black-2">Grid
                                                layout</a></li>
                                        <li><a href="blog-sidebar-left.html" class="menu-link-text link text_black-2">Left
                                                sidebar</a></li>
                                        <li><a href="blog-sidebar-right.html" class="menu-link-text link text_black-2">Right
                                                sidebar</a></li>
